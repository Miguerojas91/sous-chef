...
const STEPS: LevelStep[] = [
  {
    title: 'La diferencia: huesos tostados',
  ...
  {
    title: 'Tostar los huesos y la mirepoix',
  ...
  {
    title: 'Pasta de tomate y cocción larga',
...
export const content: LevelContent = {
  ...
  missionTags: ['6–8 horas', 'Tostado en horno'],
  steps: STEPS,
  errors: ERRORS,
  recipe: RECIPE,
