...
const STEPS: LevelStep[] = [
  {
    title: 'Comprende la reacción: qué es Maillard',
  ...
  {
    title: 'Prepara la proteína: seca y salpimenta',
  ...
  {
    title: 'La sartén: temperatura muy alta',
  ...
  {
    title: 'Dorar: coloca y no muevas',
