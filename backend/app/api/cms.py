...
requieren admin. La lectura de una página es pública (el frontend la
renderiza), pero no auto-crea páginas: así nadie llena la tabla con slugs
arbitrarios.
"""
...
async def update_page(
    ...
    if not page:
        # El admin crea la página al editarla por primera vez.
